...
shinyUI(dashboardPage(skin = "black",
  ...
  ##### Sidebar 
  dashboardSidebar(
    sidebarUserPanel("Paul Cho", "NYC Data Science Academy"),
    sidebarMenu(
      ...
      tabItem(tabName = "home",
              fluidRow(
                ...
                box(background = "navy",id = "home",solidHeader = TRUE,width = 12, 
                    ...
                    h3("From the fall of giant brick-and-mortar stores such as Sears, Maceys JCPenney... etc, e-commerce is a must option for retail companies going forward. As many of you all experinced, one of the biggest differentiators between the Amazon and other online retailers' is the speed of delivery."),
                    ...
                    h5("This is a Brazilian e-commerce public dataset of orders made at Olist Store. The dataset has information of 100k orders from 2016 to 2018 made at multiple marketplaces in Brazil. (src: Kaggle)", align='center')
                    ))
